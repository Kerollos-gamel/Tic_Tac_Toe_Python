...
def start_new_game():
    ...
    label.config(text=(player + " Play Now!"))
...
window = Tk()
window.title("Tic-Tac-Toe Kerolos' Team ")
...
label = Label(text=(player + " Play Man!"), font=('consolas', 40))
label.pack(side="top")

restart_btn = Button(text="Play Again!", font=(
